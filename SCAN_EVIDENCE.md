...
branch=work
head=<current>
FAIL: no git remotes configured (expected origin).
```

Conclusion: PR payloads can be generated, but a pullable PR cannot be created
until a remote and push credentials are configured.
