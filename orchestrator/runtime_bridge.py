...
def _build_worker_assignments(
    ...
    for idx, spec in enumerate(specs, start=1):
        ...
        avatar = spec_metadata.get("avatar", {})
        rbac = spec_metadata.get("rbac", {})
        ...
        spec_metadata.setdefault("avatar", avatar)
        spec_metadata.setdefault("rbac", rbac)
...
def _build_runtime_assignment(
    *,
    ...
    api_skill_tokens: List[Dict[str, str]],
    template_route: Dict[str, Any],
    style_temperature_profile: Dict[str, Any],
) -> RuntimeAssignmentV1:
    token_stream_stats = {
    ...
    return RuntimeAssignmentV1(
        ...
        api_skill_tokens=api_skill_tokens,
        template_route=template_route,
        style_temperature_profile=style_temperature_profile,
...
def build_handshake_bundle(
    *,
    ...
    infrastructure_agent = worldline_block.get("infrastructure_agent", {})
    ...
    runtime_assignment = _build_runtime_assignment(
        ...
        kernel_model=kernel_model,
        runtime_bridge_metadata=runtime_bridge_metadata,
        api_skill_tokens=infrastructure_agent.get("api_skill_tokens", []),
        template_route=infrastructure_agent.get("template_route", {}),
        style_temperature_profile=infrastructure_agent.get(
