...
class DMNGlobalVariable(BaseModel):
    """Global variable record consumed by DMN and XML adapters."""

    name: str
    value: str
    source: Literal["env", "runtime", "mcp", "kernel"]
    dmn_key: str
    xml_path: str
...
class RuntimeAssignmentV1(BaseModel):
    ...
    dmn_global_variables: List[DMNGlobalVariable] = Field(default_factory=list)
